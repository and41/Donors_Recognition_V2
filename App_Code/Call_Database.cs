...
{
    private const string conn = @"Data Source = tcp:protoserv.database.windows.net,1433;Database=DonorsRec;User ID = asd41;Password=GWuxia#@;Trusted_Connection=False;Encrypt=True;";
