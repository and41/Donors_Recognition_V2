...
public partial class FormPages_Commons : System.Web.UI.Page
{
    DataTable dtCommons;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Call_Database callCommons = new Call_Database();
        dtCommons = callCommons.dbCommons;

        HtmlGenericControl div, h, p;

        foreach (DataRow row in dtCommons.Rows)
        {
        ...
        Repeater1.DataSource = SearchCommonsDB.dbCommons;
        Repeater1.DataBind();
